...
>(
	...
	return {
		...
		type: docChange.type,
		isEqual: (other: FirelordFirestore.DocumentChange) => {
			return docChange.isEqual(
				other as FirelordFirestore.DocumentChange<T['read']>
			)
		},
	}
}
...
> = (
	...
	isEqual: (other: FirelordFirestore.DocumentChange) => boolean
}
